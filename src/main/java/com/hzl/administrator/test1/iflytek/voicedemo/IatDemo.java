package com.hzl.administrator.test1.iflytek.voicedemo;
...
import com.hzl.administrator.test1.R;
import com.hzl.administrator.test1.Thread.ClientThread;
import com.hzl.administrator.test1.iflytek.speech.setting.IatSettings;
import com.hzl.administrator.test1.iflytek.speech.util.ApkInstaller;
import com.hzl.administrator.test1.iflytek.speech.util.FucUtil;
import com.hzl.administrator.test1.iflytek.speech.util.JsonParser;
...
public class IatDemo extends Activity implements OnClickListener {
	...
	private void printResult(RecognizerResult results) {
		...
		if(resultBuffer.toString().indexOf("开") != -1)
		{
			ClientThread clientThread=new ClientThread(100);
			new Thread(clientThread).start();
		}else if (resultBuffer.toString().indexOf("关") != -1){
			ClientThread clientThread=new ClientThread(0);
			new Thread(clientThread).start();
		}
